        ...
        public void SeedDatabase()
        {
            ...
            db.NewsArticles.AddRange(
                new NewsArticle
                {
                    ...
                    Content = "Microsoft has announced the general availability of .NET 10, the latest version of its unified development platform. Building on the foundations established by previous releases, .NET 10 focuses on improving runtime performance, streamlining developer workflows, and expanding support for modern cloud-native applications.<br><br>One of the headline improvements is the enhanced runtime, which delivers noticeable performance gains across common workloads. Developers can expect faster application startup times, reduced memory consumption, and improved throughput, making it easier to build responsive applications that scale efficiently under heavy demand.<br><br>As businesses continue to modernize their technology stacks, .NET 10 positions itself as a compelling platform for building everything from lightweight web APIs to enterprise-scale distributed systems. With its emphasis on performance, productivity, and cloud readiness, Microsoft's latest release represents another significant step forward for the .NET ecosystem.",
                },
                new NewsArticle
                {
                    PublishDate = DateTime.UtcNow,
